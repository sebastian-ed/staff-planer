insert into public.workers (name, worker_type, target_hours, hire_date, notes) values
  ('Ramirez Melina', 'full_time', 44, '2025-01-15', 'Operaria fija'),
  ('Human Romina', 'part_time', 24, '2025-03-10', 'Media jornada'),
  ('Zerpa Sabrina', 'insurance', null, '2024-11-20', 'Seguro por horas');
